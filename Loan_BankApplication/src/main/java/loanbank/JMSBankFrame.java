...
import bankbrokerappgateway.BankBrokerAppGateway;
...
public class JMSBankFrame extends JFrame {
    ...
    private BankBrokerAppGateway loanBrokerAppGateway;
    /**
        ...
        btnSendReply.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                if (rr != null && reply != null) {
                    ...
                    try{
                        loanBrokerAppGateway = new BankBrokerAppGateway();
                        loanBrokerAppGateway.sendBankRequest(reply);
                    }catch(Exception ex){
                        ex.printStackTrace();
                    }
